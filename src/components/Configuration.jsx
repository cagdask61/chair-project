                        ...
                        <div className="flex flex-col gap-y-2 bg-white/10 rounded p-3">
                            ...
                            <div className="grid grid-cols-12 gap-3">
                                {textures.map((texture) => (
                                    <button key={texture.key} onClick={() => textureState.change(texture.key)} className={"w-14 h-14 col-span-4 rounded-full hover:outline hover:outline-1 hover:outline-white " + (textureState.key === texture.key ? "outline outline-2 outline-white" : "")}>
